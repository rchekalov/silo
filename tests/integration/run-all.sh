...
run_test "venv-auto-activate" "$SCRIPT_DIR/execution/venv-auto-activate.sh" "python"
run_test "pyproject-editable" "$SCRIPT_DIR/execution/pyproject-editable.sh" "python"
run_test "pytest-workflow" "$SCRIPT_DIR/execution/pytest-workflow.sh" "python"
run_test "poetry-workflow" "$SCRIPT_DIR/execution/poetry-workflow.sh" "python"
run_test "uv-workflow" "$SCRIPT_DIR/execution/uv-workflow.sh" "python"
run_test "python-version-pin" "$SCRIPT_DIR/execution/python-version-pin.sh" "python"
